function [p,result,chushi,wen_jiehe]=space_mark_3(A,B,tt,Q1,Q2,x1)
[n,t]=size(A);
info = zeros(n,t);
...
for sss=1:3
    for j=1:3
        ...
        jieguo(j,:,sss)=[aa0 ab0 ac0 ];
    end
end


res=[jieguo(:,:,1);jieguo(:,:,2);jieguo(:,:,3)];

p=[res./repmat(sum(res,2),1,3) sum(res,2)];
